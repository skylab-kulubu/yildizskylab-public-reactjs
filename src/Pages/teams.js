...
const TeamsPage = () => {
  ...
  return (
    <section
      className='h-screen snap-start relative pt-24 lg:pt-36 bg-customDarkPurple white' id='teams'
    >
        ...
        <div className='flex ml-3 lg:ml-0 justify-between w-auto items-center'>
          ...
          <div
            ...
            className={`px-3 pt-[0.2rem] py-[0.1rem] cursor-pointer ${
              teamSelect === 'social' ? 'bg-customAccent' : 'bg-customDarkPurple'
            } `}
          >
            SOSYAL EKİPLER
          </div>
      ...
      <div className='w-screen text-sm lg:text-md flex mt-10 lg:mt-28 justify-center'>
        <div className='font-inter w-11/12 lg:w-1/2 text-center text-customLightPink tracking-widest text-lg'>
          {TeamsData[teamSelect].find(team => team.name === selectedTeam).details}
        </div>
      </div>
    </section>
  );
